...
EgammaAnalysis/ElectronTools/data/ScalesSmearings -b
...
git clone
https://github.com/lsoffi/RecoEgamma-ElectronIdentification.git
data/RecoEgamma/ElectronIdentification/data
