...
do
  ...
  reqn=$(echo "${nam}_${pubdn}" | sed 's%_RunIIFall15MiniAODv2_PU25nsData2015v1_76X_mcRun2_asymptotic_v12_%%g' | sed 's%AODFASTSIM.*%AODFASTSIM%g')
